    ...
    def __init__(self):
        ...
        if not self.target_frame_ or not self.source_frame_:
            self.get_logger().error(
                "'target_frame' and 'source_frame' parameters must be set."
            )
        ...
        self.get_logger().info(
            f"Configured to publish orientation of '{self.target_frame_}' "
        ...
        self.publisher_ = self.create_publisher(
            QuaternionStamped, "articutool/estimated_orientation", qos_profile
        )
